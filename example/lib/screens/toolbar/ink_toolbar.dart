...
class InkToolbarPage extends StatefulWidget {
  const InkToolbarPage({super.key});

  @override
  State<InkToolbarPage> createState() => _InkToolbarPageState();
}

class _InkToolbarPageState extends State<InkToolbarPage> with PageMixin {
  ...
  Widget build(BuildContext context) {
    return ScaffoldPage.scrollable(
      header: const PageHeader(title: Text('Ink Toolbar')),
      children: [
        const Text(
