...
class PipsPagerPage extends StatefulWidget {
  const PipsPagerPage({super.key});

  @override
  State<PipsPagerPage> createState() => _PipsPagerPageState();
}

class _PipsPagerPageState extends State<PipsPagerPage>
    with PageMixin {
  ...
  Widget build(final BuildContext context) {
    return ScaffoldPage.scrollable(
      header: const PageHeader(title: Text('PipsPager')),
      children: [
        const Text(
