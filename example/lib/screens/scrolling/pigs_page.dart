...
class PigsPagePage extends StatefulWidget {
  const PigsPagePage({super.key});

  @override
  State<PigsPagePage> createState() => _PigsPagePageState();
}

class _PigsPagePageState extends State<PigsPagePage> with PageMixin {
  ...
  Widget build(BuildContext context) {
    return ScaffoldPage.scrollable(
      header: const PageHeader(title: Text('Pigs Page')),
      children: [
        const Text(
