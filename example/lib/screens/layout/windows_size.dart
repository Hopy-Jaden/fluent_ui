...
class WindowsSizePage extends StatefulWidget {
  const WindowsSizePage({super.key});

  @override
  State<WindowsSizePage> createState() => _WindowsSizePageState();
}

class _WindowsSizePageState extends State<WindowsSizePage> with PageMixin {
  ...
  Widget build(BuildContext context) {
    return ScaffoldPage.scrollable(
      header: const PageHeader(title: Text('Windows Size')),
      children: [
        const Text(
