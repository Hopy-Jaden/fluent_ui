        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              ...
              Link(
                uri: Uri.parse('https://github.com/bdlukaa/fluent_ui'),
                builder: (context, followLink) => HoverButton(
                        ...
                        child: Card(
                          child: SizedBox(
                            ...
                            child: Column(
                              ...
                              mainAxisAlignment: MainAxisAlignment.end,
                              children: [
                                const Icon(WindowsIcons.code, size: 30),
                                ...
                                const Text(
                                  'Explore the source code of the Fluent UI library and repository.',
                                ),
                                const SizedBox(height: 10),
                                const Icon(WindowsIcons.open_in_new_window),
                              ],
                            ),
                          ),
                        ),
                        ...
                        child: SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'A native look-and-feel out of the box. - June 21, 2022',
                              ),
                              SizedBox(height: 10),
              ...
              Link(
                uri: Uri.parse(
                  'https://learn.microsoft.com/en-us/windows/apps/introduction',
                ),
                builder: (context, followLink) => HoverButton(
                  onPressed: followLink,
                  builder: (final context, final states) {
                          ...
                          child: SizedBox(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 15),
                                Text(
                                  'Win UI Documentation',
                                  style: theme.typography.bodyStrong,
                                ),
                                Text(
                                  'Get started with WinUI and explore detailed documentation',
                                ),
                                SizedBox(height: 10),
                                Icon(WindowsIcons.open_in_new_window),
                              ],
                          ...
                          child: SizedBox(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Guidelines and toolkits for creating stunning WinUI experiences.',
                                ),
                                SizedBox(height: 10),
                                Icon(WindowsIcons.open_in_new_window),
                              ],
                          ...
                          child: SizedBox(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 15),
                                Text(
                                  'Fluent UI 2 Documentation',
                                  style: theme.typography.bodyStrong,
                                ),
                                Text(
                                  'Explore the official Fluent UI 2 documentation by Microsoft.',
                                ),
                                SizedBox(height: 10),
                                Icon(WindowsIcons.open_in_new_window),
                              ],
