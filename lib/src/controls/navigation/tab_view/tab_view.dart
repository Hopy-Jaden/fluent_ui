...
enum TabViewPosition {
  /// The tab view is at the top
  top,

  /// The tab view is at the bottom
  bottom,

  /// The tab view is at the left
  left,

  /// The tab view is at the right
  right,
}
...
class TabView extends StatefulWidget {
  ...
  const TabView({
    ...
    this.tabViewPosition = TabViewPosition.top,
  });
    ...
    properties
      ...
      ..add(
        EnumProperty(
          'tabViewPosition',
          tabViewPosition,
          defaultValue: TabViewPosition.top,
        ),
      ); // Added property
  }
}
...
class _TabViewState extends State<TabView> {
  ...
  Widget _tabBuilder(
    ...
    final tabWidget = TabData(
      ...
      tabViewPosition: widget.tabViewPosition,
      child: tab,
    );
  ...
  Widget build(BuildContext context) {
    ...
    final Widget tabBar = Column(
      children: [
        if (widget.tabViewPosition == TabViewPosition.top)
          ScrollConfiguration(
        ...
        if (widget.tabViewPosition == TabViewPosition.bottom)
          SizedBox(height: widget.isRoundedCorners ? 8.0 : 0.0),
        if (widget.tabViewPosition == TabViewPosition.bottom)
          ScrollConfiguration(
            behavior: const _TabViewScrollBehavior(),
            child: Container(
              margin: const EdgeInsetsDirectional.only(bottom: 4.5),
              padding: const EdgeInsetsDirectional.only(start: 8),
              height: _kTileHeight,
              width: double.infinity,
              child: Row(
